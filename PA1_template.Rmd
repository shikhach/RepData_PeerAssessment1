...
###Conclusion:
* We can see from both the graphs above that activity levels on weekends are much higher and frequent as compared to weekdays hence the number of steps is higher on weekends.  